 ...
 * TODO: Ich nutze aus, dass die letzten 3 bits jeder erster speicheradresse einer allokation 0 sind und erkenne mit tag leaf dann, in dem ich den letzten bit doch auf 1 setze, ob mein knoten ein Leaf ist
 */
...
namespace pinguqueen {
    ...
    struct LeafNode : public Node {
        std::string full_key; // Der komplette Pfad zur Verifizierung
        FileInfo* metadata = nullptr;
    };
